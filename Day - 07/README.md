...
## 📌 Overview
This file contains **26 JavaScript practice questions with solutions** covering:  
...
## 🎯 Topics Covered
- How to use the **Fetch API** to make API requests  
- Difference between **.then()** chaining and **async/await**  
- Handling **errors in API calls**  
- Converting **objects → JSON strings** and **strings → objects**  
- Performing **GET & POST requests** with APIs  
- Fetching and displaying limited data using **slice()**  

---

## 💡 What I Practiced & Learned
- Learned how to fetch data using `.then()` and `async/await`.  
- Used **try...catch** for better error handling.  
- Worked with **real APIs** (JSONPlaceholder, Joke API).  
- Learned **POST request** with headers and body.  
- Practiced `JSON.stringify()` and `JSON.parse()` for data conversion.  
- Displayed selected API results using **forEach() & slice()**.  
- Handled edge cases like **invalid URLs** and **empty responses**.  
